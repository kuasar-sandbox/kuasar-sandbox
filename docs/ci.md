...
| x86_64 / source checks | Required unit/race/vet, ENOSPC, Collector source regressions, UFFD | Sandboxer and orchestrator source checks passed on isolated native precheck; public source/UFFD job pending | Actual standard-runner check remains required |
